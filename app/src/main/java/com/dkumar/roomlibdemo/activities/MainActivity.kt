...
class MainActivity : AppCompatActivity() {
    ...
    private fun init(){
        ...
        if(empId>0){
            ...
            textView_title.text = "Update Employee"
            button_save_employee.text = "Update"
        ...
        button_save_employee.setOnClickListener {
            ...
            if(empId>0)
            {
                ...
                Toast.makeText(this,"Employee $emp_name has been updated successfully.",Toast.LENGTH_LONG).show()

            } else {
                myDb.myDao().addEmployee(obj_emp)
                Toast.makeText(this,"Employee $emp_name has been added successfully.",Toast.LENGTH_LONG).show()
            }
